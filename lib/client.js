...
function AutomationsView(props) {
  ...
  const automations = (0, import_react.useMemo)(() => [...snapshot?.automations ?? []], [snapshot]);
  const runs = (0, import_react.useMemo)(() => sortRunsDesc(snapshot?.runs ?? []), [snapshot]);
  const closeEditor = () => {
    setEditor({ open: false, mode: "create", form: emptyForm((/* @__PURE__ */ new Date()).toISOString()) });
  };
  const openCreate = () => {
    setEditor({ open: true, mode: "create", form: emptyForm(snapshot?.serverNow ?? (/* @__PURE__ */ new Date()).toISOString()) });
  };
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "kyl-panel", "data-panel": "automations", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "kyl-toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "kyl-scope", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "kyl-chip", children: [
          t("workspace"),
          ": ",
          workspace?.title ?? "\u2014"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "kyl-chip kyl-chip-muted", title: workspace?.cwd, children: workspace?.cwd }),
...
var inject = ["slots", "locale", "sessions", "layout", "connection", "remote"];
